  ...
  return (
    <div className="flex w-full  flex-col items-center justify-center  cursor-pointer">
      <div className="w-full flex items-center justify-between h-[64px] sm:px-[64px] px-[28px]">
        ...
        <button className="  btn sm:hidden max-[650px]:hidden md:hidden">Talk to Us</button>
          ...
          <div className=" flex justify-between gap-3 py-[16px] px-[64px] min-[750px]:hidden">
            <div className="lg:flex text-start gap-3 w-80 ">
              ...
              <div>
                ...
                <p className="font-Inter text-sm text-[#2A2738]">Learn more about our company and services</p>
              </div>
            </div>
            <div className="flex text-start gap-3 w-80">
              ...
              <div>
                ...
                <p className="font-Inter text-sm text-[#2A2738]">Explore our portfolio and client testimonials</p>
              </div>
            </div>
            <div className="flex text-start gap-3 w-80">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <div>
                ...
                <p className="font-Inter text-sm text-[#2A2738]">Find answers to frequently asked questions</p>
              </div>
            </div>
            <div className="flex text-start gap-3 w-80">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <div>
                ...
                <p className="font-Inter text-sm text-[#2A2738]">Join our team and grow your career</p>
              </div>
            </div>
          </div>
        </div>

        <p className=" font-Inter text-sm text-[#2A2738]  bg-surface/200 py-2 ">Looking for new job opportunities? <span className=" underline">Get in Touch </span></p>
      </div>
    </div>
  );
};
