...
const PortfolioContent = () => {
  return (
    <div className="flex w-full flex-col">
      <div className="w-full relative flex justify-center items-end bg-portfolio rounded-xl pt-8 lg:pt-16 overflow-hidden sm:mt-10 lg:mt-20 animate-slideUp opacity-0 translate-y-24 sm:px-8">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col sm:flex-row w-full   sm:justify-between gap-x-6 gap-y-5">
          <div className="flex w-full sm:w-1/2 max-sm:justify-center">
            <p className="text-2xl font-bold lg:text-3xl max-sm:text-3xl">
              See the live website
            </p>
          </div>
          <div className="flex flex-col max-sm:items-center w-full sm:w-1/2 gap-y-6">
            <p className="font-medium max-sm:text-center">
        ...
        <div className="flex w-full items-center flex-col mt-10 lg:mt-20 gap-y-5 xl:mt-32 lg:gap-y-8">
          ...
          <div className="flex justify-center">
            <div className="flex items-center gap-x-4 max-sm:flex-col">
              ...
              <div className="w-[1px] h-20 bg-gray-400 hidden sm:block" />
